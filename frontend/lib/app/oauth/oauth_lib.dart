...
class OAuthSettings {
  final OAuth _oauth = OAuth(
    tokenUrl: 'http://localhost:8080/cot-1.0-SNAPSHOT/api/oauth/token',
    refreshUrl: 'http://localhost:8080/cot-1.0-SNAPSHOT/api/oauth/refresh',
    loginUrl: 'http://localhost:8080/cot-1.0-SNAPSHOT/api/oauth/signin',
    preLoginUrl: 'http://localhost:8080/cot-1.0-SNAPSHOT/api/oauth/presignin',
